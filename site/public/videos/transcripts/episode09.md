# CLI, integrations, companion, and plugins
...
## 23. Note showing the appended PR link.
...
## 24. Settings surface, linear_token.
...
## 28. Split: local merge vs. PR recap.
...
## 29. A long-running fan-out on the board.
...
## 31. Security overlay: localhost vs 0.0.0.0.
...
## 34. Phone showing runs with activity chips.
...
## 35. Phone: type and send a follow-up.
...
## 36. Diagram: append-only event log.
...
## 41. A plugins directory with a plugin.toml.
...
## 48. [[tool]] block with typed params.
...
## 50. Split: process vs WASM runtimes.
...
## 54. A minimal hello plugin manifest + runtime.ts.
...
## 55. The runtime.ts reading newline-JSON.
...
## 56. Command palette shows "Say Hello".
